...
const Services = () => {
  ...
  return (
    <section ref={sectionRef} id="services" style={{ position: 'relative', overflow: 'hidden', background: '#0a0a0a', padding: '120px 80px' }}>
      ...
      <div
        style={{
          ...
          zIndex: 0,
          pointerEvents: 'none',
          background: 'radial-gradient(ellipse 900px 600px at 50% 60%, rgba(130,55,15,0.25) 0%, transparent 65%)',
        }}
      />
      ...
      <div style={{ position: 'relative', zIndex: 1, maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <div ref={headerRef} style={{ textAlign: 'center' }}>
          ...
          {/* CTAs */}
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', marginTop: '36px', gap: '20px' }}>
        ...
        {/* Bento Grid - 3 columns: 1.1fr 1.8fr 1.1fr */}
        <div
          ref={gridRef}
          style={{
            display: 'grid',
            gridTemplateColumns: '1.1fr 1.8fr 1.1fr',
            gridTemplateRows: '320px 460px 340px',
            gap: '14px',
            width: '100%',
            maxWidth: '1200px',
            margin: '64px auto 0',
        ...
        >
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div>
                ...
                <h3 style={{ fontFamily: 'Space Grotesk, sans-serif', fontSize: '26px', fontWeight: 700, color: 'white', marginTop: '18px' }}>
                  Web Development
                </h3>
          ...
          <div style={{ background: '#111113', borderRadius: '20px', padding: '32px 36px', border: '1px solid rgba(255,255,255,0.055)', display: 'flex', flexDirection: 'column', overflow: 'hidden', position: 'relative', gridArea: '1 / 3 / 3 / 4' }}>
            ...
            <div style={{ marginTop: 'auto', display: 'flex', gap: '12px', justifyContent: 'center', alignItems: 'flex-end', paddingBottom: '20px' }}>
              {/* Icon 1 - Grid/Circles */}
              <div style={{ width: '70px', height: '70px', background: 'rgba(255,255,255,0.03)', borderRadius: '12px', border: '1px solid rgba(255,255,255,0.08)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              ...
              {/* Icon 4 - App Icon */}
              <div style={{ width: '70px', height: '70px', background: '#fff', borderRadius: '14px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          ...
          <div style={{ background: '#111113', borderRadius: '20px', padding: 0, border: '1px solid rgba(255,255,255,0.055)', display: 'flex', flexDirection: 'column', gridArea: '2 / 1 / 4 / 2', overflow: 'hidden', position: 'relative' }}>
          ...
          <div style={{ background: 'linear-gradient(145deg, #1a1025 0%, #2a1d3d 40%, #1f1530 70%, #160f24 100%)', borderRadius: '20px', padding: 0, border: '1px solid rgba(255,255,255,0.055)', display: 'flex', alignItems: 'center', justifyContent: 'center', position: 'relative', overflow: 'hidden', gridArea: '2 / 2 / 3 / 3' }}>
            {/* Subtle glow behind shape */}
            <div style={{ position: 'absolute', width: '300px', height: '300px', background: 'radial-gradient(circle, rgba(120,60,200,0.3) 0%, transparent 70%)', right: '10%', top: '50%', transform: 'translateY(-50%)' }} />
            {/* 3D Geometric Arrow Shape */}
            ...
            {/* Text centered */}
            <h3 style={{ fontFamily: 'Space Grotesk, sans-serif', fontSize: '46px', fontWeight: 800, color: 'white', textAlign: 'center', letterSpacing: '-1px', position: 'relative', zIndex: 1 }}>
              Everything<br />in One Place
            </h3>
          </div>

          {/* Card 6+7 - 3D Animation + FX Dashboard Combined (col 2-3, row 3) */}
          <div style={{ background: '#111118', borderRadius: '20px', border: '1px solid rgba(255,255,255,0.055)', display: 'flex', position: 'relative', overflow: 'hidden', gridArea: '3 / 2 / 4 / 4' }}>
            {/* LEFT SIDE - 3D Animation Text */}
            <div style={{ flex: '0 0 40%', padding: '32px', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
              ...
              <h3 style={{ fontFamily: 'Space Grotesk, sans-serif', fontSize: '28px', fontWeight: 700, color: 'white', marginTop: '16px' }}>
                3D Animation
              </h3>
            ...
            {/* RIGHT SIDE - FX Dashboard Visual */}
            <div style={{ flex: 1, background: '#0d0d18', borderRadius: '16px', margin: '12px', padding: '16px', display: 'flex', flexDirection: 'column', position: 'relative' }}>
              {/* Top Bar */}
